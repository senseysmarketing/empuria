    ...
    <div className="space-y-6">
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex gap-3 items-start">
        ...
        <div className="text-sm text-amber-900">
          <strong>Provedor não conectado.</strong> A configuração e os templates ficam salvos no painel. Quando você conectar um provedor de WhatsApp/E-mail, os gatilhos ativos passam a disparar automaticamente.
        </div>
      </div>
