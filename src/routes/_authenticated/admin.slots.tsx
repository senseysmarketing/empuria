  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="font-display text-4xl font-bold tracking-tight">Vagas & Slots</h1>
          <p className="text-admin-ink-muted text-sm mt-1">Cadastre horários disponíveis para Tours e Reuniões Presenciais.</p>
        </div>
